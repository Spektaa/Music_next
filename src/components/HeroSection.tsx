        ...
        <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center
            ...
            <div className="p-4 relative z-10 w-full text-center">
                ...
                <p  className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, dolorum earum sed saepe doloremque suscipit illo voluptates rem? A vel cumque in laborum recusandae illo debitis ex facilis qui animi!
                </p>
